      ...
      <div class="container">
        <div class="row mb-5">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                <li><a href="#" class="py-2 d-block">Acharya Polytechinc</a></li>
                <li><a href="#" class="py-2 d-block">80 - 28396011</a></li>
                <li><a href="#" class="py-2 d-block">principalait@acharya.ac.in</a></li>
                <li><a href="#" class="py-2 d-block">www.acharya.ac.in</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            <p>
              Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved<i class="icon-heart"aria-hidden="true"></i> by <a href="https://projectworlds.in" target="_blank">Acharya Polytechinc</a>
            </p>
          </div>
        </div>
      </div>
